...
# documentation for the princomp() function 
help("princomp")
principal_components <- princomp(irisdata1, cor = TRUE, score = TRUE)

# cor = logical value indicating whether calculation should
...
# score = logical value indicating whether the score on
...
#plot the principal components similar to a line
plot(principal_components, type = "l")

#plot the principal components using biplot
help("biplot")
biplot(principal_components)

#-----------------------------------------------------------------
#PCA using Boston dataset
library(MASS)
...
#different means.
# apply() function allows us to apply a function-in this case, the mean() function
